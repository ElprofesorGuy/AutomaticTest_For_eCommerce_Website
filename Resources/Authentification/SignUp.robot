...
*** Keywords ***
Create Account
    Wait Until Element Is Visible  //*[@id="auth-connect-id"]
    ...
    Scroll ELement Into View    id=registerModel_LastName
    ...
    Scroll Element Into View  //*[@id="registerModel_Phone"]
...
Create Account With Invalid Email
    ...
    Scroll Element Into View   //*[@id="registerModel_Password"]
